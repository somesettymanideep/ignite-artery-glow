...
export const SERVICES: Service[] = [
  ...
  },
  {
    ...
    title: "AV Fistula for Dialysis & Fistula Salvage",
    ...
    faqs: [
      { q: "What is an AV fistula procedure in kidney patients?", a: "An AV fistula connects an artery to a vein in the arm, making the vein stronger and larger so it can be used repeatedly for haemodialysis needles. It is the safest and most durable dialysis access for kidney patients." },
      { q: "What are fistula salvage procedures?", a: "Fistula salvage includes angioplasty to widen narrowing, thrombectomy to remove clots, stent placement and banding for high-flow fistulas. These procedures restore or prolong dialysis access without creating a new fistula." },
      { q: "How long does an AV fistula take to mature?", a: "Most simple fistulas mature in 4–6 weeks; complex fistulas may take 8–12 weeks. We monitor with duplex scans before starting cannulation." },
      { q: "Is AV fistula creation painful?", a: "The procedure is performed under anaesthesia, so it is painless. Mild soreness for a few days is common and controlled with simple medication." },
      { q: "Who creates the best AV fistulas?", a: "Vascular surgeons are specifically trained in vessel anatomy, ultrasound mapping and microsurgical techniques that produce durable, well-functioning fistulas for dialysis patients." },
    ],
  },
  {
