...
import vascularImg from "@/assets/about-vascular.jpg?url";
import surgeryImg from "@/assets/about-surgery.jpg?url";

const aboutBanner = resolveAssetUrl(aboutBannerAsset.url);
const receptionImg = resolveAssetUrl(receptionAsset.url);
const doctorImgFull = resolveAssetUrl(doctorImgAsset.url);
...
function Doctor() {
  const bullets = ["Expert in Endovascular Procedures", "Varicose Veins Specialist", "Peripheral Arterial Disease Expert", "Diabetic Foot Care Specialist", "Deep Vein Thrombosis Expert", "Expert in Simple and Complicated AV Fistula Surgeries"];
  return (
    <section className="bg-white py-16 lg:py-20">
        ...
        <Reveal className="reveal" variant="left">
          <div className="relative">
            ...
            <div className="relative overflow-hidden rounded-3xl bg-secondary shadow-lift">
              <img src={doctorImgFull} alt="Dr. G. Narasimha Sai" width={520} height={640} loading="lazy" className="h-[360px] w-full object-cover" />
            </div>
          </div>
        </Reveal>
