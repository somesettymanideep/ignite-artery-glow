...
const doctorImg = resolveAssetUrl("/src/assets/doctor-portrait.jpg");
const secondOpinionDoctorAsset = { url: resolveAssetUrl("/src/assets/second-opinion-doctor.png") };
const whyImg = resolveAssetUrl("/src/assets/why-choose.jpg");
const secondOpinionBanner = resolveAssetUrl("/src/assets/second-opinion-banner.jpg");
  ...
  return (
    <section className="relative overflow-hidden bg-[#f7f8fc] pt-32 lg:pt-40">
      <div className="mx-auto grid max-w-7xl items-center gap-8 px-5 pb-16 lg:grid-cols-[1.15fr_0.95fr] lg:gap-12 lg:pb-20 lg:px-8">
        ...
        {/* Right image */}
        <Reveal variant="right" delay={0.12} className="relative mx-auto w-full max-w-md lg:max-w-none lg:mx-0">
          <ServicesCarousel />
        </Reveal>
      </div>
    </section>
