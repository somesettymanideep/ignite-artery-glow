...
export const Route = createFileRoute("/contact")({
  head: () => ({
    ...
    links: [
      { rel: "canonical", href: "https://ignite-artery-glow.lovable.app/contact" },
    ],
  }),
...
function ContactForm() {
  ...
  return (
    <section className="py-6 sm:py-10 lg:py-14">
      <div className="mx-auto grid max-w-7xl grid-cols-[minmax(0,1fr)] items-start gap-6 px-4 sm:gap-8 sm:px-6 lg:grid-cols-[minmax(0,1fr)_minmax(320px,420px)] lg:px-8">
