...
const REELS: Reel[] = [
  { webm: resolveAssetUrl("/reels/ignite-reel-1.webm"), video: resolveAssetUrl("/reels/ignite-reel-1.mp4"), poster: resolveAssetUrl(reel1), caption: "Inside Ignite Vascular Center — a look at our advanced vascular care", likes: "12.4k", comments: 218, views: "84k", tag: "#IgniteVascular" },
  { webm: resolveAssetUrl("/reels/ignite-reel-2.webm"), video: resolveAssetUrl("/reels/ignite-reel-2.mp4"), poster: resolveAssetUrl(reel2), caption: "Dr. Narasimha Sai on early signs of varicose veins you shouldn't ignore", likes: "9.1k", comments: 342, views: "62k", tag: "#VaricoseVeins" },
  { webm: resolveAssetUrl("/reels/ignite-reel-3.webm"), video: resolveAssetUrl("/reels/ignite-reel-3.mp4"), poster: resolveAssetUrl(reel3), caption: "3D walkthrough — how a diabetic foot ulcer heals with vascular care", likes: "7.6k", comments: 154, views: "48k", tag: "#DiabeticFoot" },
  { webm: resolveAssetUrl("/reels/ignite-reel-4.webm"), video: resolveAssetUrl("/reels/ignite-reel-4.mp4"), poster: resolveAssetUrl(reel4), caption: "Live patient story: back to walking pain-free after PAD treatment", likes: "15.2k", comments: 487, views: "1.1M", tag: "#PatientStory" },
];
